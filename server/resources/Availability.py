...
class SearchAvailability(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            return {
                "error": "hotelId, arrivalDate, departureDate, partySize required"
            }, 400

        if departure <= arrival:
            return {
                "error": "departureDate must be after arrivalDate"
            }, 400
...
#         combinations = suggest_room_combinations(
#             hotel_id,
#             arrival,
#             departure,
#             party_size
